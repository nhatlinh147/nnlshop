        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="section-block" id="basicform">
                    <h3 class="my-2 section-title">Danh mục sản phẩm</h3>
                    <div class="card">
                        <div class="card-body">
                            <?php
                            ...
                            ?>
                            <form role="form" action="{{ route('backend.save_category') }}" method="post"
                                id="Form_Category_Product">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control category_product_slug"
                                        name="category_product_slug" id="convert_slug">
                                </div>
                                {{-- <div class="form-group">
