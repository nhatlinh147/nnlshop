            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="javascript:void(0)" class="btn btn-info ml-3" id="create-cate-pro" style="float: right; margin-bottom:15px;margin-right: 7px"><span class="fas fa-plus"></span>  Thêm danh mục</a>
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="cate_pro_id" id="cate_pro_id">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control category_product_name" name="category_product_name" placeholder="Enter Tilte" value="" onkeyup="ChangeToSlug()" id="slug">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="name" class="col-sm-6">Slug danh mục sản phẩm</label>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control category_product_slug" name="category_product_slug" placeholder="Enter Tilte" id="convert_slug" value="">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <textarea class="form-control category_product_desc" name="category_product_desc" id="Ckeditor_Desc" rows="3" value=""></textarea>
                                </div>
                            </div>
                            <div class="form-group">
